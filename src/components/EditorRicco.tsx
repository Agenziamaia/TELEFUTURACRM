...
// SANIFICATORE spostato in src/lib/sanificaHtml.ts (perf: importarlo da qui trascinava
// l'intero editor nel bundle condiviso via ComunicazioniPopup). Re-export per
// compatibilità con chi importa `sanificaHtml` da @/components/EditorRicco.
