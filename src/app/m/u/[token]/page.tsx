...
const LABEL = { documento: "Documenti", contratti: "Contratti", altro: "Altro", fattura: "Fattura", documento_usato: "Documento d'identità (usato)", dichiarazione_usato: "Dichiarazione di vendita (usato)" };
