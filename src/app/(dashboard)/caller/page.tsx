...
function CallerPageInner() {
    ...
    const faseInfo = useCallback((c: Call): { fase: FaseCaller; giorniMalus: number; importo: number; dalMalus: Date | null } => {
        // ASSORBITE = morte (check profondo Luca 05/08): il cliente ha risposto
        // su un'altra riga, nessun caller puo' piu' lavorarle — niente fase e
        // niente malus che matura. Era QUESTA la contraddizione "archivio pieno,
        // filtro vuoto": il filtro le nascondeva (giusto) ma il motore le
        // calcolava ancora in malus e la sync teneva gli episodi In corso per
