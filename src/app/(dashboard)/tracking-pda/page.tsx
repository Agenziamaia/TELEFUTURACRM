...
const CATEGORIE = [
    { id: "mnp", label: "MNP", desc: "Portabilità mobile", color: "var(--tf-6366f1)", icon: Phone },
    { id: "fisso", label: "Fisso", desc: "Linee fisse tutti gli op.", color: "var(--tf-0ea5e9)", icon: MapPin },
    { id: "finanziamento", label: "Finanziamento", desc: "Wind / VF / Fastweb", color: "var(--tf-f59e0b)", icon: DollarSign },
    { id: "piva", label: "P.IVA", desc: "Vodafone Business", color: "var(--tf-8b5cf6)", icon: Building },
    { id: "energia", label: "Energia", desc: "Luce & Gas tutti gli op.", color: "var(--tf-10b981)", icon: Zap },
    { id: "sky", label: "Sky", desc: "Sky 3P / Sky solo V", color: "var(--tf-ef4444)", icon: LayoutGrid },
];
...
const STATI_NEGOZIO_MNP = STATI_NEGOZIO.filter(s => s.id !== "doc_mancante" && s.id !== "contattare_supporto").concat([
    { id: "re_inserita", label: "Re-Inserita", color: "var(--tf-38bdf8)", bg: "var(--tf-0c2a3f)" },
]);
