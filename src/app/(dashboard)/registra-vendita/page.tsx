   ...
   i riquadri "Dati contratto" erano azzurro Vodafone anche in Fastweb */
    ...
    esce prima di montarlo e i suoi bottoni restavano senza stile. */}
      ...
      {vistaStep==="brand"&&<div className="rvCard" style={{padding:20}}>
        ...
        {posScontrinoAbilitato(selNeg) && <ContiSospesi negozio={selNeg} onRiprendi={riprendiSospeso} reloadKey={sospesoReload} />}
        {/* Il modale Incasso & Scontrino era reso SOLO nella vista carrello: qui allo
            step Brand "Riprendi" impostava lo stato ma non c'era il modale da aprire.
            È un portale che non mostra nulla finché data===null. */}
        <ScontrinoCassa data={scontrino} onDone={scontrino?.sospesoId ? chiudiSospeso : chiudiScontrino} onCommit={runPendingCommit} />
