...
const FILE = "20260824260000_caller_vendite_segnalate.sql";
(async () => {
    ...
    const n = (await client.query("select count(*)::int n from information_schema.tables where table_name='caller_vendite_segnalate'")).rows[0];
    console.log("tabella caller_vendite_segnalate:", n?.n === 1 || n?.n === "1" ? "presente ✅" : "ASSENTE ❌");
    await client.end();
})();
